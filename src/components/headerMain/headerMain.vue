<template>
  ...
  <section class="header-main">
    <div>
     this is headerMain vue component
    </div>


  <transition name="modal" v-if="showmask" >
...
<button id="show-modal" @click="showmask = !showmask">show mask</button>
  ...
  <button id="show-modal" v-on:click="showModal = !showModal">show message</button>

  <transition name="actionFade">
    <div id="message" v-if="showModal"> 
     <h3>this is modal show</h3>
    </div>
  </transition>
  </section>
